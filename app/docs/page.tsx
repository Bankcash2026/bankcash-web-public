...
const SECTIONS = [
  ...
  {
    h: 'Referrals',
    b: 'Share your link (bcash.fun/ref/CODE). The inviter earns 5 cashback per friend; the invited degen gets a free spin ticket. Self-referral and duplicate referrals are blocked.',
  },
  {
    h: 'Security',
